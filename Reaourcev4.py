...
# RESOURCE VARIATIONS with istio-proxy
RESOURCE_VARIATIONS = [
    {
        "your-app-container": {
    ...
    {
        "your-app-container": {
            "requests": {"cpu": "300m", "memory": "192Mi"},
...
def main():
    ...
    try:
        ...
        for i, variation in enumerate(extended_variations):
            ...
            deployment = apps_v1.read_namespaced_deployment(deployment_name, namespace)
            patch_deployment_resources(apps_v1, deployment, variation, namespace)
